...
describe UserSignup do 
	describe "#sign_up" do
      ...
      it "stores the customer token from stripe" do
        ...
        UserSignup.new(Fabricate.build(:user, email: "joe@example.com", password: "password", name: "Joe Doe")).sign_up("some_stripe_token", invitation.token)
      ...
      it "sends out email containing the user's name with valid inputs" do
        UserSignup.new(Fabricate.build(:user, email: "joe@example.com", name: "Joe Smith")).sign_up("some_stripe_token", nil)
    ...
    context "for invalid personal info" do
    	before do
        UserSignup.new(User.new(email: "bob")).sign_up("1231241", nil)
      end
      ...
      it "does not send out email with invalid inputs", vcr: true  do
