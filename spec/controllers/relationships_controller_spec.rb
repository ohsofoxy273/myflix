...
describe RelationshipsController do
	describe "GET index" do
		it "sets @relationships to the current user's following relationships (the relationships they are following)" do
	...
	describe "POST create" do
		...
		it "creates the relationship that the current user follows the leader" do
			alice = Fabricate(:user)
			set_current_user(alice)
			bob = Fabricate(:user)
		...
		it "does not allow one to follow themsevles" do
			alice = Fabricate(:user)
			set_current_user(alice)
