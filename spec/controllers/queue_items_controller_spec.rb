...
describe QueueItemsController do
  ...
  describe "POST create" do
    ...
    it "puts the video as the last one in the queue" do 
      ...
      post :create, user: alice, video_id: south_park.id
      south_park_queue_item = QueueItem.where(user_id: alice.id, video_id: south_park.id).first
    ...
    it "does not add the video to the queue if it is already in the queue" do
      ...
      monk = Fabricate(:video)
      Fabricate(:queue_item, user: alice, video: monk)
      post :create, user: alice, video_id: monk.id
